    ...
    <div class="hero-inner">
      ...
      <div class="hero-meta">
        ...
        <div class="hero-meta-item"><svg viewBox="0 0 24 24">
          ...
          </svg><span>Phiên bản: <strong>v2.1</strong></span></div>
      </div>
    </div>
  </div>
    ...
    <main class="policy-content rv d1">
      ...
      <div class="section-block" id="s2">
        ...
        <ul class="policy-list">
          ...
          <li><strong>Dữ liệu kỹ thuật:</strong> Địa chỉ IP, loại trình duyệt, thời gian truy cập (thu thập tự động qua
            cookie để tối ưu website).</li>
        </ul>
        <div class="info-box">
          <p>TavaLED cam kết không thu thập các thông tin nhạy cảm của cá nhân như niềm tin tôn giáo, quan điểm chính
            trị, hoặc dữ liệu sức khỏe cá nhân.</p>
        </div>
      </div>
      ...
      <div class="section-block" id="s3">
        ...
        <p class="sec-text">Thông tin khách hàng được lưu trữ trong thời gian cần thiết để thực hiện mục đích đã nêu
          hoặc theo quy định của pháp luật:</p>
        <ul class="policy-list">
          <li>Thông tin tư vấn: Lưu trữ 02 năm kể từ lần liên hệ cuối cùng.</li>
          <li>Thông tin hợp đồng & bảo hành: Lưu trữ tối thiểu 10 năm theo quy định của Luật Kế toán và để phục vụ công
            tác bảo trì dài hạn.</li>
      ...
      <div class="section-block" id="s4">
        ...
        <div class="info-box">
          <p><strong>Tuyệt đối không:</strong> Chúng tôi cam kết không bán, chia sẻ hoặc cho thuê thông tin khách hàng
            cho bất kỳ bên thứ ba nào vì mục đích quảng cáo.</p>
        </div>
      </div>
      ...
      <div class="section-block" id="s5">
        ...
        <div style="background:var(--light);border:1px solid var(--bdr);border-radius:10px;padding:24px">
          ...
          <p style="font-size:14px;color:var(--mid);margin-bottom:4px">📍 Trụ sở: Lô BT36-06 KĐT Tràng Duệ, An Dương,
            Hải Phòng</p>
          <p style="font-size:14px;color:var(--mid);margin-bottom:4px">📞 Điện thoại: 0934 29 8181</p>
      ...
      <div class="section-block" id="s6">
        ...
        <p class="sec-text">Để thực hiện các quyền này, vui lòng gửi email về <strong>tuyen.tavaco@gmail.com</strong>
          hoặc gọi hotline <strong>0934 29 8181</strong>. Chúng tôi sẽ phản hồi và xử lý trong vòng 72 giờ làm việc.</p>
      </div>
      ...
      <div class="section-block" id="s8">
        ...
        <p class="sec-text">Trong trường hợp khách hàng phát hiện thông tin cá nhân bị sử dụng sai mục đích hoặc phạm vi
          đã thông báo:</p>
        <ul class="policy-list">
          <li><strong>Bước 1:</strong> Khách hàng gửi khiếu nại qua email hoặc hotline phía trên.</li>
          <li><strong>Bước 2:</strong> TavaLED tiến hành xác minh và làm việc trực tiếp với khách hàng trong vòng 03
            ngày làm việc.</li>
          <li><strong>Bước 3:</strong> Đưa ra biện pháp khắc phục (xin lỗi, điều chỉnh dữ liệu, bồi thường nếu có thiệt
            hại thực tế).</li>
        </ul>
      </div>
      ...
      <div class="section-block" id="contact">
        ...
        <div class="contact-box">
          <div class="contact-item">
            ...
            <div>
              <div class="contact-item__lbl">Phòng An ninh dữ liệu</div>
              <div class="contact-item__val">Công ty Tava Việt Nam</div>
            </div>
          </div>
          <div class="contact-item">
            <div class="contact-item__ico"><svg viewBox="0 0 24 24">
            ...
            <div>
              ...
              <div class="contact-item__val"><a href="mailto:tuyen.tavaco@gmail.com">tuyen.tavaco@gmail.com</a></div>
            </div>
          </div>
        </div>
      </div>
