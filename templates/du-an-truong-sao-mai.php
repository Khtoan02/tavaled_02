...
<div class="bg-[#f8f9fa] font-sans text-[#17264a] selection:bg-[#f36428]/20">
  ...
  <section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-24 relative z-20 mb-28">
    <div class="bg-white rounded-[2rem] shadow-2xl shadow-[#17264a]/5 border border-slate-100 p-2 grid grid-cols-1 md:grid-cols-4 gap-2">
      ...
      <div class="bg-[#f8f9fa] p-6 rounded-[1.5rem] hover:bg-white hover:shadow-lg transition-all duration-300 group border border-transparent hover:border-slate-100">
        ...
        <p class="text-lg font-black text-[#f36428]">Đang khởi công</p>
      </div>
  ...
  <!-- SHOWCASE TEASER - Hành trình tiếp nối -->
  <section class="bg-gradient-to-br from-[#17264a] via-[#0f1933] to-[#17264a] py-32 px-4 text-center border-t-[6px] border-[#f36428] relative overflow-hidden">
    <!-- Cinematic glow effect -->
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[500px] bg-[#f36428]/15 blur-[120px] rounded-full pointer-events-none"></div>
    
    <div class="max-w-4xl mx-auto relative z-10">
      <span class="text-[#f36428] font-black tracking-widest text-sm uppercase mb-6 flex items-center justify-center gap-2">
        <!-- SVG Clock -->
        ...
        Đón chờ diễn biến tiếp theo
      </span>
      <h2 class="text-5xl md:text-6xl lg:text-7xl font-black text-white mb-8 tracking-tight leading-tight drop-shadow-2xl">
        Khoảnh Khắc Bừng Sáng <br class="hidden md:block"/>
        <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#f36428] to-[#ff8c5a]">Sắp Bắt Đầu</span>
      </h2>
      <p class="text-slate-300 mb-12 text-lg md:text-xl font-medium leading-relaxed max-w-2xl mx-auto">
        Khi nền móng vững chãi đã hoàn thành, cũng là lúc "linh hồn" của siêu dự án chuẩn bị được khoác lên. Hãy lưu lại trang nhật ký này để cùng TavaLED đếm ngược đến ngày sân khấu Sao Việt thực sự tỏa sáng rực rỡ!
      </p>
      
      <!-- Status Indicator -->
      <div class="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-white/5 border border-white/10 text-slate-200 font-bold backdrop-blur-md shadow-2xl">
        <span class="relative flex h-3 w-3">
          <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#f36428] opacity-75"></span>
          <span class="relative inline-flex rounded-full h-3 w-3 bg-[#f36428]"></span>
        </span>
        Đang tiến hành lắp đặt màn hình LED...
      </div>
    </div>
  </section>
