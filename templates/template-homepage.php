...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { border-radius: 0 !important; }
        body { font-family: 'Inter', sans-serif; background: #0f172a; color: #ffffff; overflow-x: hidden; cursor: none; }
        ...
        /* HERO VIDEO OVERLAY */
        .hero-video-wrap { position: absolute; inset: 0; z-index: 0; overflow: hidden; background: #020617; pointer-events: none; }
        ...
        .hero-overlay { position: absolute; inset: 0; background: linear-gradient(to bottom, rgba(2,6,23,0.3) 0%, rgba(2,6,23,0.8) 60%, #020617 100%); }
        ...
        .gallery-overlay {
            ...
            width: 100%;
            height: 400px;
            background: linear-gradient(to bottom, transparent, #020617 80%, #020617 100%);
            display: flex;
    ...
    <main>
        ...
        <section class="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden bg-brand-navy3">
            ...
            <div class="hero-video-wrap">
                <!-- SỬ DỤNG THẺ VIDEO HTML5 THAY CHO YOUTUBE ĐỂ ĐẢM BẢO AUTOPLAY 100% -->
                <video autoplay loop muted playsinline>
                    <!-- Link video background sân khấu chất lượng cao (mp4) -->
                    <source src="https://cdn.pixabay.com/video/2020/06/05/41138-427771746_large.mp4" type="video/mp4">
        ...
        <section id="editorial" class="py-32 bg-[#020617] border-t border-white/5">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-start">
                    ...
                    <div class="lg:col-span-5 reveal-up lg:sticky lg:top-32">
                        ...
                        <div class="relative overflow-hidden mb-8 aspect-video border border-white/10 group interactive">
                            ...
                            <div class="absolute bottom-0 left-0 w-full bg-gradient-to-t from-[#0f172a] to-transparent p-6">
                    ...
                    <div class="lg:col-span-7 space-y-4 reveal-up delay-1 mt-8 lg:mt-0">
                        ...
                        <div class="faq-item border-b border-white/10 bg-[#0f172a] group">
        ...
        <!-- ================= SECTION 7: CTA ================= -->
        <section class="relative py-40 overflow-hidden bg-[#020617] flex items-center justify-center border-t border-brand-orange">
