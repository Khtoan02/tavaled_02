...
<style>
.tava-du-an-page * { box-sizing: border-box; }
...
.tava-du-an-page { font-family: var(--font-body); background: var(--bg); color: var(--navy); }
...

<main class="tava-main-content tava-du-an-page">
