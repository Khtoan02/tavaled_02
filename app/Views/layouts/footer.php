        ...
        <div class="container mx-auto px-4 lg:px-8 max-w-7xl relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 mb-12">
                ...
                <div class="md:col-span-5 lg:col-span-3">
                    ...
                    <div class="mb-8 space-y-4">
                        <p>
                            <a href="tel:<?php echo esc_attr(preg_replace('/[^0-9+]/', '', \App\Helpers\ThemeHelper::getOption('phone_kd', '0934298181'))); ?>" class="text-slate-300 hover:text-brand-orange text-[17px] transition-colors flex items-center gap-3 group">
                                ...
                                <span class="font-bold tracking-widest"><?php echo esc_html(\App\Helpers\ThemeHelper::getOption('phone_kd', '0934 298 181')); ?></span>
                            </a>
                        </p>
                        <p>
                            <a href="tel:<?php echo esc_attr(preg_replace('/[^0-9+]/', '', \App\Helpers\ThemeHelper::getOption('phone_cskh', '0329249536'))); ?>" class="text-slate-300 hover:text-brand-orange text-[17px] transition-colors flex items-center gap-3 group">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="text-brand-orange group-hover:scale-110 transition-transform"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
                                <span class="font-bold tracking-widest"><?php echo esc_html(\App\Helpers\ThemeHelper::getOption('phone_cskh', '0329 249 536')); ?></span>
                            </a>
                        </p>
                        <p>
            ...
            <div class="border-t border-slate-700 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <div class="flex gap-4">
                    ...
                    <a href="https://zalo.me/<?php echo esc_attr(preg_replace('/[^0-9]/', '', \App\Helpers\ThemeHelper::getOption('zalo', '0934298181'))); ?>" target="_blank" class="w-10 h-10 bg-white/5 border border-slate-700 flex items-center justify-center text-slate-400 hover:text-white hover:bg-brand-orange hover:border-brand-orange transition-all duration-300" title="Zalo">
